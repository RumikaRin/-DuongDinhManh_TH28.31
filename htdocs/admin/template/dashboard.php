...
// Tổng doanh thu (Chỉ tính các đơn hàng Đã xử lý hoặc Đang xử lý)
$sql_revenue = "SELECT COALESCE(SUM(tongtien),0) as total_revenue FROM donhang WHERE trangthai='Hoàn thành' OR trangthai='Đang xử lý'";
